...
<div class="row">
    <div class="col-sm-12">
        <form action="<?php echo base_url('trading/update'); ?>" method="post" enctype="multipart/form-data" >
            <div class="row">
                <div class="col-sm-12">
            ...
            <div class="row">
                <div class="col-sm-12">
                    ...
                    <a href="<?php echo base_url('trading/tradinglist'); ?>" class="btn btn-success btn-sm">Back</a>
                </div>
            </div>
            <div class="row">

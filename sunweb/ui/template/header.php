            ...
            <div class="container" id="container" style="margin-top:-8px;padding:5px 0;">
              ...
              <div class="navbar-header">
                <button type="button" class="navbar-toggle collapsed" data-toggle="collapse" data-target="#bs-example-navbar-collapse-1" aria-expanded="false">
                  ...
                  <a class="navbar-brand" href="<?php echo base_url(); ?>" style="color:#FFF">
                      <img align="left" src="<?php echo base_url('assets/images/logo.png'); ?>" width="80" height="40" style="margin-top:-13px;" />
              ...
              <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav" id="nav1" style="margin-left: 54px">
					...
					<li><a href="<?php echo base_url('page/view/26');?>">Career</a></li>
					<li><a href="<?php echo base_url('page/view/25');?>">Contact Us</a></li>
					<li><a href="<?php echo base_url('page/view/27');?>">About Us</a></li>

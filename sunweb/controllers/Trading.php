...
class Trading extends CI_Controller {
    ...
    public function index(){
        ...
        $this->load->view('home/tradingservice',$data);
    ...
    public function tradingList(){
        ...
        $this->load->view('master/trading-list',$data);
    ...
    public function edit(){
        ...
        $data['training']= $this->TrainingModel->getTraining();
        $this->load->view('master/header',$data);
        $this->load->view('master/trading-edit',$data);
        $this->load->view('master/footer');
    }
    ...
    public function update(){
        ...
        $this->load->library('upload', $config);
            ...
            redirect(base_url('trading/tradinglist'));
